...
CREATE TABLE Termination (
    ...
    Termination_AssetHandoverStatus VARCHAR2(20) DEFAULT 'Pending' CHECK (Term_AssetHandoverStatus IN ('Pending', 'In Progress', 'Completed', 'Failed')),
    ...
    Termination_BreachOfContractCode VARCHAR2(15) NOT NULL,
    Termination_AssetHandoverPeriod INTEGER NOT NULL CHECK (Termination_AssetHandoverPeriod BETWEEN 0 AND 90),
    Investor_ID VARCHAR2(15) NOT NULL,
...
CREATE TABLE Social (
    ...
    Traffic_Congestion_Impact_Rating VARCHAR2(10) NOT NULL CHECK (Traffic_Congest_Impact_Rating IN ('Low', 'Medium', 'High')),
    Assessment_ID VARCHAR2(15) NOT NULL,
...
CREATE TABLE Quality_Record (
    ...
    Inspection_Remedial_Action_Required VARCHAR2(3) NOT NULL CHECK (Inspection_Remedial_Action_Required IN ('Yes', 'No')),
    Investor_ID VARCHAR2(15) NOT NULL,
    Timeline_ID VARCHAR2(20) NOT NULL,
    IS_ID VARCHAR2(15) NOT NULL,
    Digital_ID VARCHAR2(15) NOT NULL,
...
CREATE TABLE Lot (
    ...
    Lot_EncroachmentFlag VARCHAR2(3) NOT NULL CHECK (Lot_EncroachmentFlag IN ('Yes', 'No')),
