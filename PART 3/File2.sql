...
WHERE A.Agreement_GoverningLaw = 'National Land Code (Act 828)' -- Constraint 1
  AND I.Department_Operation_Budget >= 1000000.00               -- Constraint 2
  AND D.Developer_Experience_Year > 0                           -- Constraint 3
